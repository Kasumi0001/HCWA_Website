        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="creambg-ls">
                    ...
                    <a type="button" class="btn btn-outline-secondary smallbutton livebtn" href="<?php the_field('postlive1'); ?>">LEARN MORE</a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="creambg-ls">
                    ...
                    <a type="button" class="btn btn-outline-secondary smallbutton livebtn" href="<?php the_field('postlive2'); ?>">LEARN MORE</a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="creambg-ls">
                    ...
                    <a type="button" class="btn btn-outline-secondary smallbutton livebtn" href="<?php the_field('postlive3'); ?>">LEARN MORE</a>
                </div>
            </div>
...
<section class="container-fluid acknowledgementbg">
    ...
    <section class="container-fluid">
        <div class="row row-no-gutters creambg2">
            ...
            <div class="col-lg-6">
                <img class="img-fluid eventimg" src=<?php the_field('imageforevent'); ?> alt="LiveIssues">
            </div>
        </div>
    </section>
